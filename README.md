...
**Field evidence:** the [public evidence ledger](https://caioribeiroclw-pixel.github.io/pluribus/field-evidence.html) links independently reviewed and merged implementations across skill use, runtime authority, context freshness, dry-run/rollback, handoff recovery, and instruction integrity. It says exactly what those merges prove—and does not call them Pluribus adoption.
